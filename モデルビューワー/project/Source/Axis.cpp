...
//	SetCameraPositionAndTarget_UpVecY(VGet(0, 300, -10), VGet(0, 0, 0)); // ÉJÉÅÉâê^è„
	...
	DrawCone3D(VGet(0, 100, 0), VGet(0, 80, 0), 7, 20, GetColor(0, 255, 0), GetColor(0, 255, 0), 1);

	DrawLine3D(VGet(0, 0, -100), VGet(0, 0, 100), GetColor(0, 0, 255));
	DrawCone3D(VGet(0, 0, 100), VGet(0, 0, 80), 7, 20, GetColor(0, 0, 255), GetColor(0, 0, 255), 1);
}
